    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          ...
          <h2 className="text-2xl font-bold text-white mb-2">{t('flashcards.error')}</h2>
    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          ...
          <h2 className="text-2xl font-bold text-white mb-2">{t('flashcards.noData')}</h2>
          <p className="text-gray-400">{t('flashcards.noStats')}</p>
        </div>
      </div>
    );
  }
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-white mb-2 flex items-center gap-3">
            <Brain className="w-10 h-10 text-kprimary" />
            {t('flashcards.title')}
          </h1>
        ...
        <div className="grid md:grid-cols-4 gap-6 mb-8">
          <div className="bg-white/5 rounded-xl p-6 border border-white/10">
            <div className="flex items-center justify-between mb-2">
              <Target className="w-8 h-8 text-kprimary" />
              <span className="text-3xl font-bold text-white">{stats.dueCount}</span>
            </div>
            <p className="text-gray-400 font-semibold">{t('flashcards.stats.due')}</p>
          </div>

          <div className="bg-white/5 rounded-xl p-6 border border-white/10">
            <div className="flex items-center justify-between mb-2">
              <Plus className="w-8 h-8 text-green-600" />
              <span className="text-3xl font-bold text-white">{stats.newCount}</span>
            </div>
            <p className="text-gray-400 font-semibold">{t('flashcards.stats.learning')}</p>
          </div>

          <div className="bg-white/5 rounded-xl p-6 border border-white/10">
            <div className="flex items-center justify-between mb-2">
              <TrendingUp className="w-8 h-8 text-purple-600" />
              <span className="text-3xl font-bold text-white">{stats.retentionRate}%</span>
            </div>
            <p className="text-gray-400 font-semibold">{t('flashcards.stats.mastered')}</p>
          </div>
          ...
          <div className="bg-white/5 rounded-xl p-6 border border-white/10">
            ...
            <p className="text-gray-400 font-semibold">{t('dashboard.stats.streak')}</p>
          </div>
        </div>
            ...
            <div className="bg-white/5 rounded-xl p-6 border border-white/10 mb-6">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-2xl font-bold text-white flex items-center gap-2">
                  <Calendar className="w-7 h-7 text-kprimary" />
                  {t('flashcards.due')}
                </h2>
              ...
              {dueFlashcards.length === 0 ? (
                ...
                <div className="space-y-4">
                  {dueFlashcards.slice(0, 5).map((flashcard) => (
                    <div
                      key={flashcard.id}
                      className="p-4 bg-white/5 rounded-lg border border-white/10 hover:border-kprimary/30 transition-colors"
                    >
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          <div className="flex items-center gap-2 mb-2">
                            <span className="text-2xl">{flashcard.subject.icon}</span>
                            <span className="text-sm font-semibold text-kprimary">
              ...
              <div className="space-y-4">
                <div>
                  <div className="flex justify-between mb-2">
                    <span className="text-gray-300 font-semibold">{t('flashcards.stats.mastered')}</span>
                ...
                <div className="grid grid-cols-2 gap-4 pt-4 border-t">
                  <div>
                    <p className="text-sm text-gray-400">Total révisions</p>
                    <p className="text-2xl font-bold text-white">{stats.totalReviews}</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-400">30 derniers jours</p>
                    <p className="text-2xl font-bold text-white">{stats.reviewedLast30Days}</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white/5 rounded-xl p-6 border border-white/10">
              ...
              <div className="space-y-3">
                <div className="flex justify-between">
                  <span className="text-gray-400">Cartes totales</span>
                  <span className="font-bold text-white">{stats.totalFlashcards}</span>
                </div>
                <div className="flex justify-between">
                ...
                <div className="flex justify-between">
                  <span className="text-gray-400">Streak actuel</span>
            ...
            <div className="bg-white/5 rounded-xl p-6 border border-white/10">
              ...
              <div className="space-y-2">
                <Link
                  to="/courses"
                  className="block px-4 py-2 bg-white/5 hover:bg-white/10 rounded-lg transition-colors text-gray-300 font-semibold"
                >
                  📚 Parcourir les cours
                </Link>
                <Link
