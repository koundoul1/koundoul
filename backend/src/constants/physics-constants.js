...
// ========================================
// CONSTANTES QUANTIQUES AVANCÉES
// ========================================
...
export const QUANTUM_CONSTANTS = {
  ...
  PLANCK_LENGTH: {
    ...
    value: 1.616e-35,
    unit: 'm',
    description: 'Longueur de Planck (√(ℏG/c³))',
    category: 'quantum'
  },
  ...
  PLANCK_TIME: {
    ...
    value: 5.391e-44,
    unit: 's',
    description: 'Temps de Planck (√(ℏG/c⁵))',
    category: 'quantum'
  },
  ...
  PLANCK_MASS: {
    ...
    value: 2.176e-8,
    unit: 'kg',
    description: 'Masse de Planck (√(ℏc/G))',
    category: 'quantum'
  },
  ...
  PLANCK_TEMPERATURE: {
    ...
    value: 1.417e32,
    unit: 'K',
    description: 'Température de Planck (√(ℏc⁵/Gk²))',
    category: 'quantum'
  },
  ...
  COMPTON_WAVELENGTH: {
    ...
    value: 2.426e-12,
    unit: 'm',
    description: 'Longueur d\'onde Compton de l\'électron',
    category: 'quantum'
  }
};

// ========================================
// CONSTANTES DU MODÈLE STANDARD
// ========================================

export const STANDARD_MODEL_CONSTANTS = {
  // Constante de couplage fort
  STRONG_COUPLING: {
    symbol: 'αₛ',
    value: 0.1,
    unit: '',
    description: 'Constante de couplage de l\'interaction forte',
  ...
  FERMI_CONSTANT: {
    ...
    value: 1.166e-5,
    unit: 'GeV⁻²',
    description: 'Constante de Fermi pour l\'interaction faible',
    category: 'standard_model'
  },
  ...
  W_BOSON_MASS: {
    ...
    value: 80.4,
    unit: 'GeV/c²',
    description: 'Masse du boson W (médiateur faible chargé)',
    category: 'standard_model'
  },
  ...
  Z_BOSON_MASS: {
    ...
    value: 91.2,
    unit: 'GeV/c²',
    description: 'Masse du boson Z (médiateur faible neutre)',
    category: 'standard_model'
  },
  ...
  HIGGS_BOSON_MASS: {
    ...
    value: 125.1,
    unit: 'GeV/c²',
    description: 'Masse du boson de Higgs',
    category: 'standard_model'
  }
};
...
export const SPECTROSCOPIC_CONSTANTS = {
  // Première constante de rayonnement
  RADIATION_CONSTANT_1: {
    symbol: 'c₁',
    value: 3.742e-16,
    unit: 'W·m²',
    description: 'Première constante de rayonnement de Planck',
    category: 'spectroscopic'
  },

  // Seconde constante de rayonnement
  RADIATION_CONSTANT_2: {
    symbol: 'c₂',
    value: 1.439e-2,
    unit: 'm·K',
    description: 'Seconde constante de rayonnement de Planck',
    category: 'spectroscopic'
  }
};
